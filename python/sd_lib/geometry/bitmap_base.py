...
from sd_lib.geometry.constants import DATA, ORIGIN, GEOMETRY_SHAPE, GEOMETRY_TYPE, \
                                               UPDATED_AT, CREATED_AT, ID, CLASS_ID#, LABELER_LOGIN,
...
from sd_lib.imaging.image import resize_inter_nearest, restore_proportional_size
